"""
WP2 Denmark Offshore AEP Calculation - Advanced Models
=======================================================
...
- Layout: HyDesign optimization

Author: Thodoris  
Date: 2026-02-11
Comparison to: run_wp2_iea_style.py (NOJ baseline)
"""
...
from py_wake.turbulence_models.crespo import CrespoHernandez    # Added as IEA had no turbulence
...
print("=" * 70)
print("WP2 DENMARK OFFSHORE - AEP CALCULATION (ADVANCED MODELS)")
print("=" * 70)
print("\nModels:")
...
bastankhah = Bastankhah_PorteAgel_2014(
    site, 
    windTurbines,
    k=0.04,  # Wake expansion coefficient for offshore (slightly higher than 0.032 for offshore)
...
print(f"  Wake expansion: k = 0.04 (offshore, higher TI than typical)")
...
if expected_cf_min <= cap_factor <= expected_cf_max:
    ...
    print(f"      Expected to be 2-5% higher than NOJ baseline")
else:
