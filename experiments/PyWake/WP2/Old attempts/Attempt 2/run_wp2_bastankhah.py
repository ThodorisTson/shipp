"""
WP2 PyWake Analysis - Bastankhah (Gaussian) Wake Model
======================================================

Refactored version aligned with NOJ structure.
"""
...
MODEL_NAME = "Bastankhah"

# Representative plotting case
WD_PLOT = 270
WS_PLOT = 10
...
print("=" * 80)
print("WP2 PYWAKE ANALYSIS - BASTANKHAH (GAUSSIAN) WAKE MODEL")
print("=" * 80)

setup = quick_setup(HPP_YAML, config=CONFIG)
...
total_capacity_mw = (
    setup["n_turbines"] * setup["turbine_dat"]["rated_power"] / 1e6
)
...
print("\n" + "=" * 80)
print("RUNNING BASTANKHAH WAKE MODEL")
print("=" * 80)
...
print("\n--- FARM SUMMARY ---")
print(f"Site: {setup['wind_resource']['name']}")
print(f"Location: {setup['wind_resource']['latitude']:.2f}°N, {setup['wind_resource']['longitude']:.2f}°E")
...
print("Sum of sector frequencies:", float(setup["wind_resource"]["frequencies"].sum()))
...
ax.set_title(f"Bastankhah Wake Map – WS={WS_PLOT} m/s, WD={WD_PLOT}°")
...
plt.tight_layout()
plt.savefig(PLOTS_DIR / "wp2_bastankhah_wake_map.png", dpi=200)
plt.close(fig)

# Per-turbine power distribution
...
ax.set_title(f"Per-Turbine Power – Bastankhah (WS={WS_PLOT} m/s, WD={WD_PLOT}°)")
plt.tight_layout()
plt.savefig(PLOTS_DIR / "wp2_bastankhah_power_distribution.png", dpi=200)
plt.close(fig)
...
ax.plot(duration_pct, sorted_power, linewidth=2.5, color="darkorange")
ax.fill_between(duration_pct, 0, sorted_power, alpha=0.15, color="darkorange")
...
ax.set_title("Bastankhah & Porté-Agel (2014) Power Duration Curve", fontsize=12, fontweight='bold')
...
plt.tight_layout()
plt.savefig(PLOTS_DIR / "wp2_bastankhah_power_duration.png", dpi=200)
plt.close(fig)
print("✓ Saved: wp2_bastankhah_power_duration.png")

# =============================================================================
# SAVE STRUCTURED SUMMARY
# =============================================================================

summary_file = PLOTS_DIR / "wp2_bastankhah2014_summary.txt"

with open(summary_file, "w") as f:
    f.write("WP2 Bastankhah & Porté-Agel (2014) Wake Model Analysis\n")
    f.write("="*60 + "\n\n")
    ...
    f.write("WAKE MODEL\n")
    f.write("-"*30 + "\n")
    f.write("Model: Bastankhah & Porté-Agel (2014)\n")
    f.write("Reference: Renewable Energy, 70, 116-123\n")
    f.write("Implementation: Literature (PyWake)\n\n")
